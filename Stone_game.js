 ...
 var play=confirm("shall we play rock,paper or scissor fun game?");
if (play){
  var pchoice=prompt("enter the rock,paper,scissor words");
  ...
  if(pchoice)
    ...
    if(
      ...
      alert("you didn't enter the value");
         ...
         alert("I guess you change your mind right...");
       }
  }
  else{
